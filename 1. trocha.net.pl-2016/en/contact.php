...
<body>
	...
	<div class="container">
		<div class="black">
			<?php include('./../cms/text/en_black.php') ?>
		</div>
		<div class="header">
			...
			<BR><BR><h1>Contact me or send me a message</h1><BR>
					...
					<td>
						<div style="float:left">
							<form method="POST" action="">
								...
								<tr>
									<td colspan="2" style="padding-top:15px;"><input type="submit" name="submit" Value="Send" />
									</td>
								</tr>
								</table>
							</form><BR>
	...
	<div class="footer">
		<?php include('./../cms/text/en_footer.php') ?>
	</div>
